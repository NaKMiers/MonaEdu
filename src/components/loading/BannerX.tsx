function BannerX() {
  return (
    <div className='carousel mt-[-72px] relative w-full h-[calc(100vh)] overflow-hidden'>
      {/* List Items */}
      <div className='list bg-white'>
        <div className='item absolute inset-0'>
          ...
          <div className='content absolute top-[20%] md:top-[15%] left-1/2 -translate-x-1/2 max-w-[1200px] px-21 w-full'>
      ...
      <div className='thumbnails absolute bottom-[50px] left-1/2 z-10 flex gap-21'>
        {Array.from({ length: 3 }).map((_, index) => (
          ...
          >
            ...
            <div className='content absolute bottom-0 left-0 right-0 bg-white bg-opacity-80 px-3 py-1 rounded-t-lg'>
