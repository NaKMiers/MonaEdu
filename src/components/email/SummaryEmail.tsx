      ...
      <Body className="text-dark font-sans">
        <Container className="bg-white p-4">
            ...
            <Row className="p-4">
              <Column className="font">
                ...
                <div className="text-sm mt-8">
                  ...
                  <p>
                    <b>Hoa hồng: </b>
                    <span className="font-semibodl text-rose-500">
                    ...
                    >
                      ...
                      <div className="inline-block w-1/2">
                        <span className="text-green-500">
                          {formatPrice(voucher.accumulated)}
                        </span>
                      </div>
                    </div>
                  ))}
                ...
                <p className="text-center text-sm text-slate-500">
                  Xin chân thành cảm ơn bạn đã đồng hành cùng MonaEdu trong thời
                  gian qua. Chúc bạn một ngày tốt lành 😊
                </p>
              </Column>
            </Row>
          </Section>
          ...
          <p className="text-center text-xs text-slate-600">
            © 2023 | MonaEdu - Developed by Nguyen Anh Khoa, All rights
            reserved.
          </p>
