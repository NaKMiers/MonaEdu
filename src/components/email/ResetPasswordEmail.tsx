      ...
      <Body className="text-dark font-sans">
        <Container className="bg-white p-4 pb-6">
          ...
          <Section className="px-5">
            ...
            <p>
              Để giữ cho tải khoản của bạn được an toàn, không chia sẻ email này
              với bất kỳ ai!
            </p>
            <p>
              Nếu bạn có thắc mắc gì? Vui lòng liên hệ để được hỗ trợ với sự tận
              tình và nhanh chống:{" "}
              <a
          ...
          <p className="text-center text-xs text-slate-600">
            © 2023 | MonaEdu - Developed by Nguyen Anh Khoa, Dao Gia Bao, Phuong
            Anh, Quoc Thang, All rights reserved.
          </p>
          ...
          <div className="text-center">
            ...
            >
              <Img
                src={`${"https://monaedu.com"}/icons/zalo.jpg`}
                width={35}
                height={35}
                alt="zalo"
              />
