...
function Header({ className = '' }: HeaderProps) {
  ...
  return (
    ...
    >
      {/* Ads */}
      <div
        className={`${openAds ? 'max-h-[200px] py-0.5 sm:max-h-12 md:max-h-6' : 'max-h-0 py-0'} trans-300 group block w-full overflow-hidden bg-gradient-to-t ${isTransparent ? 'from-transparent' : 'from-[#2f2e3e]'} to-primary px-3 text-center font-body text-sm tracking-wider text-light`}
