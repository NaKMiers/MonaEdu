      ...
      <div className="max-w-1200 mx-auto">
        ...
        <div className="flex items-center justify-between gap-21">
          <div className="flex items-center gap-4 py-3">
            <div className="flex items-center gap-2">
              ...
              <span className="font-body text-primary font-bold text-3xl">
                MonaEdu
              </span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-12 py-3 gap-7 text-center md:text-left">
          <div className="flex flex-col col-span-12 md:col-span-10">
            ...
            <p className="font-body tracking-wider mt-2">
              Mona Edu brings you online learning solutions, studying online at
              home at an economical cost. best. This is suitable for those whose
              finances are still tight and limited (students, real trainees, new
              graduates,...) but can still participate in top value courses to
              Develop professional skills and develop your career. If you want
              to save more on your investment If you are interested in learning,
              Mona Edu is the ideal destination for you.
            </p>
          </div>
        ...
        <div className="flex flex-wrap items-center justify-center md:justify-between gap-x-5 gap-y-1 text-center">
          <p className="text-[14px] transition-all duration-300 hover:tracking-wide">
            © <span className="text-primary font-semibold">Mona Edu</span>. All
            rights reserved
          </p>
          <Link
