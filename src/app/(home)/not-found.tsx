  ...
  return (
    <div className="h-[calc(100vh-72px)] pb-20 flex items-center justify-center px-21">
      <div className="text-center">
        ...
        <h2 className="bg-dark font-semibold text-xl sm:text-2xl md:text-3xl">
          404 - Không tìm thấy trang
        </h2>

        <Divider size={6} />

        <p className="font-body tracking-wider font-semibold max-w-[400px] mx-auto text-slate-700">
          Trang bạn đang tìm kiếm không tồn tại hoặc đã bị xóa. Vui lòng kiểm
          tra lại đường dẫn.
        </p>
