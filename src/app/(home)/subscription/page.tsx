...
async function SubscriptionPage() {
  ...
  return (
    <div className='-my-[72px] py-[72px] flex-col min-h-screen bg-gradient-to-b from-neutral-950 to-neutral-800 relative flex items-center w-full justify-center overflow-hidden'>
      <Divider size={40} />

      <h2 className='text-2xl relative z-20 md:text-4xl lg:text-7xl font-bold text-center text-light font-sans tracking-tight'>
