    ...
    <div>
      ...
      <div className='bg-neutral-800 md:-mt-[72px] md:pt-[72px]'>
        ...
        <div className='max-w-1200 mx-auto md:pt-21'>
          {/* Banner */}
          <div className='w-full aspect-[7/3] md:aspect-[3/1] lg:aspect-[9/2] rounded-b-3xl md:rounded-t-3xl shadow-lg bg-slate-700 animate-pulse' />
          ...
          <div className='relative -mt-[84px] md:mt-0 md:h-[104px]'>
            <div className='md:absolute sm:right-6 md:right-12 md:top-0 z-10 flex flex-col-reverse md:flex-row justify-center items-center md:items-end md:justify-end gap-3 md:-translate-y-1/2'>
              <div className='flex flex-col items-center md:items-end justify-end text-light pb-4 gap-1.5'>
              ...
              <div className='w-full rounded-full aspect-square overflow-hidden flex-shrink-0 max-w-[168px] border-[4px] border-slate-700 bg-slate-300 shadow-lg' />
            </div>
          </div>
        </div>
      </div>
